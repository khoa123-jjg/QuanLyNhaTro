...
public interface IAdminNguoiDungRepository
{
    ...
    Task<AdminNguoiDungEditViewModel?> GetChinhSuaNguoiDungAsync(int id);

    Task<(bool Success, string Message)> ChinhSuaNguoiDungAsync(AdminNguoiDungEditViewModel model);
}
